...
Thanks for using streamy! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/simonpcouch/streamy/issues/new).
...
requests](https://github.com/simonpcouch/streamy/issues) to make sure
