...
This outlines how to propose a change to streamy. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("simonpcouch/streamy", fork = TRUE)`.
...
Please note that the streamy project is released with a [Contributor
Code of
Conduct](https://simonpcouch.github.io/streamy/CODE_OF_CONDUCT.md). By
